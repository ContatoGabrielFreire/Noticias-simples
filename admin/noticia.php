    ...
    <body>	
        <div id="status-bar">
            <div class="container_12">
                <ul id="status-infos">
                    <li class="spaced">Dream Gallery Developed by:: <strong> <a href="http://clares.com.br" target="_blank">Clares</a></strong></li>
                </ul>             
            </div>        
        </div> 
            ...
            <div class="grid_12">
                ...
                <div class="block-border">
                    <div class="block-content">
                        <h1>Área Restrita - Notícias
                            <?php
                            if ( isset( $_GET ) && !empty( $_GET ) )
                            {
                                ?>
                                <a href="noticia.php" class="with-tip"  title="Notícias">
                        ...
                        <div class="block-controls">
                            <ul class="controls-tabs js-tabs with-children-tip">
                                ...
                                <li class="current"><a href="noticia.php" title="Notícias">
                                                ...
                                                <form action="noticia.php?update=true" method="post" class="form" enctype="multipart/form-data">
                                                    <ul class="box-album-head" style="width: 101%; margin:0; margin-bottom: 20px; padding: 0 !important">
                                                        <fieldset class="grey-bg inline-label">
                                                            <legend>Detalhes da Notícia</legend>
                                                            <p>
                                                                <label for="noticia_title">Título da Notícia</label>
                                                                <input type="text" name="noticia_title" value="<?= $noticia_title ?>" id="noticia_title" />
                                                            </p>
                                                        </fieldset>
                                                        <div>
                                                        ...
                                                        <Br />
                                                        <p>
                                                            <label for="noticia_foto">Alterar Imagem da Notícia</label>
                                                        ...
                                                        <p style="text-align: center; margin-top:20px;">
                                                            <button class="grey" style="margin-left: 30px;">Atualizar Notícia</button>
                                                        </p>
                                        ...
                                        <form name="f" action="noticia.php?create=true" method="post" class="form"
                                            ...
                                            <ul class="box-album-head" style="width: 101%; margin:0; margin-bottom: 20px; padding: 0 !important">
                                                ...
                                                <fieldset class="grey-bg inline-label">
                                                    ...
                                                    <p>
                                                        <label for="noticia_title">Título da Notícia</label>
                                                        <input type="text" name="noticia_title" id="noticia_title" />
                                                    </p>
                                                </fieldset>
                                                <div>
                                                    <h3>Conteúdo da Notícia</h3>
                                                ...
                                                <p style="text-align: right">
                                                    <button class="grey" style="margin-left: 30px;">Cadastrar Notícia</button>
                                                </p>
                                        ...
                                        <tbody class="sortableBanner">                             
                                            ...
                                            if ( $db->rows >= 1 )
                                            {
                                                ...
                                                foreach ( $albuns as $album )
                                                {
                                                    ...
                                                    ?>
                                                <td> 
                                                    <a class="with-tip edit" title="editar notícia" href="noticia.php?edit=<?= $alb->noticia_id ?>">
                                                        <img src="tpl/images/pencil.png" width="16" height="16">
                                                    </a> 
                                                    &nbsp;
                                                    <a class="with-tip deleteNoticia" title="remover notícia"  id="<?= $alb->noticia_id ?>" href="javascript:void(0)">
